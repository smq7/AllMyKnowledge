...
/* ......................................................................................... */
    ...
    public static void main(String[] args) throws IOException {
        ...
        Folder folder = Folder.fromDirectory(new File("D:\\nice"));
        String str = "vad";
...
//            counts = wordCounter.countOccurrencesOnSingleThread(folder, str);
...
//        
        for (int i = 0; i < repeatCount; i++) {
            startTime = System.currentTimeMillis();
            counts = wordCounter.countOccurrencesInParallel(folder, str);
            stopTime = System.currentTimeMillis();
        ...
        for (int i = 0; i < repeatCount; i++) {
            System.out.println(forkedThreadTimes[i]);
        }
        System.out.println();
    }
}
